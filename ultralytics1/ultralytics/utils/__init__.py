...
HELP_MSG = """
    ...
    2. Use the Python SDK:
        ...
        results = model.yolov12_val()  # evaluate model performance on the validation set
    ...
    3. Use the command line interface (CLI):
        ...
        Ultralytics 'yolo' CLI commands use the following syntax:
            ...
            Where   TASK (optional) is one of [detect, segment, classify, pose, obb]
                    MODE (required) is one of [train, yolov12_val, predict, export, track, benchmark]
        ...
        - Val a pretrained detection model at batch-size 1 and image size 640:
            yolo detect yolov12_val model=yolo11n.pt data=coco8.yaml batch=1 imgsz=640
...
# Set logger
LOGGER = set_logging(LOGGING_NAME, verbose=VERBOSE)  # define globally (used in train.py, yolov12_val.py, predict.py, etc.)
