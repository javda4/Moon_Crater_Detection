...
def on_fit_epoch_end(trainer) -> None:
    """Callback function called at end of each fit (train+yolov12_val) epoch."""
...
def on_val_end(validator) -> None:
    ...
    if run:
        ...
        _log_images({f.stem: str(f) for f in validator.save_dir.glob("yolov12_val*.jpg")}, "Validation")
