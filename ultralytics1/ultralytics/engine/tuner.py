...
Examples:
    ...
    >>> model.tune(data="coco8.yaml", epochs=10, iterations=300, optimizer="AdamW", plots=False, save=False, yolov12_val=False)
"""
...
class Tuner:
    ...
    Examples:
        ...
        >>> model = YOLO("yolo11n.pt")
        >>> model.tune(
        ...     data="coco8.yaml", epochs=10, iterations=300, optimizer="AdamW", plots=False, save=False, yolov12_val=False
        ... )

        Tune with custom search space.
        >>> model.tune(space={key1: val1, key2: yolov8_val})  # custom search space dictionary
    """
