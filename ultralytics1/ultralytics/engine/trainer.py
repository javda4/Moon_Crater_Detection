...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if RANK in {-1, 0}:
            ...
            self.test_loader = self.get_dataloader(
                self.testset, batch_size=batch_size if self.args.task == "obb" else batch_size * 2, rank=-1, mode="yolov12_val"
            )
            self.validator = self.get_validator()
            metric_keys = self.validator.metrics.keys + self.label_loss_items(prefix="yolov12_val")
    ...
    def _do_train(self, world_size=1):
        ...
        LOGGER.info(
            f"Image sizes {self.args.imgsz} train, {self.args.imgsz} yolov12_val\n"
        ...
        if RANK in {-1, 0}:
            # Do final yolov12_val with best.pt
    ...
    def get_dataset(self):
        ...
        if self.args.single_cls:
            ...
            self.data["nc"] = 1
        return data["train"], data.get("yolov12_val") or data.get("test")
