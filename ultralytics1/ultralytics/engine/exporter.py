...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if any(f):
            ...
            s = (
                ""
                if square
                else f"WARNING ⚠️ non-PyTorch yolov12_val requires square images, 'imgsz={self.imgsz}' will not "
                f"work. Use export 'imgsz={max(self.imgsz)}' if yolov12_val is required."
            )
            ...
            LOGGER.info(
                ...
                f"\nValidate:        yolo yolov12_val task={model.task} model={f} imgsz={imgsz} data={data} {q} {s}"
    ...
    def get_int8_calibration_dataloader(self, prefix=""):
        ...
        dataset = YOLODataset(
            data[self.args.split or "yolov12_val"],
            data=data,
