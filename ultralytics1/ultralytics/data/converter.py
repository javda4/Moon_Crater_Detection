...
def convert_coco(
    ...
    for json_file in sorted(Path(labels_dir).resolve().glob("*.json")):
        ...
        if lvis:
            # NOTE: create folders for both train and yolov12_val in advance,
            # since LVIS yolov12_val set contains images from COCO 2017 train in addition to the COCO 2017 yolov12_val split.
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    The function processes images in the 'train' and 'yolov12_val' folders of the DOTA dataset. For each image, it reads the
    ...
    for phase in ["train", "yolov12_val"]:
