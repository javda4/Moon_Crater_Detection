...
def load_yolo_dota(data_root, split="train"):
    ...
    Args:
        ...
        split (str): The split data set, could be `train` or `yolov12_val`.
        ...
        The directory structure assumed for the DOTA dataset:
            - data_root
                ...
                - labels
                    ...
                    - yolov12_val
    """
    assert split in {"train", "yolov12_val"}, f"Split must be 'train' or 'yolov12_val', not {split}."
...
def split_trainval(data_root, save_dir, crop_size=1024, gap=200, rates=(1.0,)):
    """
    Split train and yolov12_val set of DOTA.
    ...
    for split in ["train", "yolov12_val"]:
