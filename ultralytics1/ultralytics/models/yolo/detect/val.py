...
class DetectionValidator(BaseValidator):
    ...
    def init_metrics(self, model):
        ...
        self.args.save_json |= self.args.val and (self.is_coco or self.is_lvis) and not self.training  # run final yolov12_val
    ...
    def build_dataset(self, img_path, mode="yolov12_val", batch=None):
        """
        Build YOLO Dataset.
    ...
    def get_dataloader(self, dataset_path, batch_size):
        ...
        """
        dataset = self.build_dataset(dataset_path, batch=batch_size, mode="yolov12_val")
