...
```bash
python yolov12_val.py --weights yolov5s.pt             # PyTorch
python yolov12_val.py --weights yolov5s.torchscript    # TorchScript
python yolov12_val.py --weights yolov5s.onnx           # ONNX Runtime or OpenCV DNN with dnn=True
python yolov12_val.py --weights yolov5s_openvino_model # OpenVINO
python yolov12_val.py --weights yolov5s.engine         # TensorRT
python yolov12_val.py --weights yolov5s.mlmodel        # CoreML (macOS Only)
python yolov12_val.py --weights yolov5s_saved_model    # TensorFlow SavedModel
python yolov12_val.py --weights yolov5s.pb             # TensorFlow GraphDef
python yolov12_val.py --weights yolov5s.tflite         # TensorFlow Lite
python yolov12_val.py --weights yolov5s_edgetpu.tflite # TensorFlow Edge TPU
python yolov12_val.py --weights yolov5s_paddle_model   # PaddlePaddle
```
...
python yolov12_val.py --weights yolov5s.onnx --dnn    # validate
```
