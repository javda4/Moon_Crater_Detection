...
```yaml
# Train/yolov12_val/test sets as 1) dir: path/to/imgs, 2) file: path/to/imgs.txt, or 3) list: [path/to/imgs1, path/to/imgs2, ..]
...
val: images/yolov12_val # yolov12_val images (relative to 'path') 4 images
...
val: images/yolov12_val # yolov12_val images (relative to 'path')
