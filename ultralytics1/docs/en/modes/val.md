...
```bash
yolo yolov12_val model=yolo11n.pt
```
...
```bash
yolo yolov12_val model=yolo11n.pt data=path/to/your/custom_dataset.yaml
```
...
```bash
yolo yolov12_val model=yolo11n.pt save_json=True
```
